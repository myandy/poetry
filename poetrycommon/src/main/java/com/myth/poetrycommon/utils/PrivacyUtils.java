...
import com.myth.poetrycommon.activity.PrivacyPolicyActivity;
import com.myth.poetrycommon.activity.TermsActivity;
import com.myth.poetrycommon.view.PrivacyDialog;
...
public class PrivacyUtils {
     ...
     * 显示用户协议和隐私政策
     */
    public static void checkAndshowPrivacy(final Activity context) {
        if (BaseApplication.instance.isCheckPrivacy()) {
            return;
        }
        ...
        btn_enter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                BaseApplication.instance.setCheckPrivacy();
            }
        });
